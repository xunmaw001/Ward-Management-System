...
public class YihurenyuanEntity<T> implements Serializable {
    ...
    public String toString() {
        return "Yihurenyuan{" +
            ...
            ", username=" + username +
            ", password=" + password +
            ", yihurenyuanName=" + yihurenyuanName +
            ", yihurenyuanPhone=" + yihurenyuanPhone +
            ", yihurenyuanIdNumber=" + yihurenyuanIdNumber +
            ", yihurenyuanPhoto=" + yihurenyuanPhoto +
            ", sexTypes=" + sexTypes +
            ", yihurenyuanEmail=" + yihurenyuanEmail +
            ", yihurenyuanZhiweiTypes=" + yihurenyuanZhiweiTypes +
