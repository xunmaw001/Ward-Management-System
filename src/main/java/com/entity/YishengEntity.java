...
public class YishengEntity<T> implements Serializable {
     ...
     * 所获荣誉
     */
    @TableField(value = "yisheng_rongyu")

    private String yishengRongyu;
	 ...
	 * 设置：所获荣誉
	 */
    public String getYishengRongyu() {
        return yishengRongyu;
    }
    /**
	 * 获取：所获荣誉
	 */

    public void setYishengRongyu(String yishengRongyu) {
        this.yishengRongyu = yishengRongyu;
    }
    /**
	 * 设置：创建时间
	 */
