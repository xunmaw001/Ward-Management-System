 ...
 */
@TableName("kaifang")
public class KaifangView extends KaifangEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 开方类型的值
		*/
		private String kaifangValue;
	...
	public KaifangView(KaifangEntity kaifangEntity) {
		try {
			BeanUtils.copyProperties(this, kaifangEntity);
			...
			* 获取： 开方类型的值
			*/
			public String getKaifangValue() {
				return kaifangValue;
			}
			/**
			* 设置： 开方类型的值
			*/
			public void setKaifangValue(String kaifangValue) {
				this.kaifangValue = kaifangValue;
			}
