...
public class BingchuangShiyongView extends BingchuangShiyongEntity implements Serializable {
	...
	public BingchuangShiyongView() {

	}

	public BingchuangShiyongView(BingchuangShiyongEntity bingchuangShiyongEntity) {
		try {
			BeanUtils.copyProperties(this, bingchuangShiyongEntity);
