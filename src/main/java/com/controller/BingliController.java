    ...
    */
    ...
    public R save(@RequestBody BingliEntity bingli, HttpServletRequest request){
        ...
        Wrapper<BingliEntity> queryWrapper = new EntityWrapper<BingliEntity>()
            ...
            .eq("yichuan_text", bingli.getYichuanText())
            .eq("zhusu_text", bingli.getZhusuText())
            .eq("zhenduan_text", bingli.getZhenduanText())
            ;
...
//                            bingliEntity.setZhuyuanTime(sdf.parse(data.get(0)));          //住院时间 要改的
//                            bingliEntity.setYichuanText(data.get(0));                    //遗传史 要改的
//                            bingliEntity.setZhusuText(data.get(0));                    //患者主诉 要改的
//                            bingliEntity.setZhenduanText(data.get(0));                    //诊断结果 要改的
