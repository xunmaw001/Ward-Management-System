...
//                            huanzheEntity.setAge(Integer.valueOf(data.get(0)));   //年龄 要改的
//                            huanzheEntity.setHuanzheEmail(data.get(0));                    //电子邮箱 要改的
//                            huanzheEntity.setHunyinTypes(Integer.valueOf(data.get(0)));   //婚姻 要改的
//                            huanzheEntity.setXianAddress(data.get(0));                    //现住址 要改的
//                            huanzheEntity.setHujiAddress(data.get(0));                    //户籍地址 要改的
