    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="库存数量" prop="yaopinKucunNumber">
                       <el-input v-model="ruleForm.yaopinKucunNumber"
                                 placeholder="库存数量" clearable  :readonly="ro.yaopinKucunNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="库存数量" prop="yaopinKucunNumber">
                           <el-input v-model="ruleForm.yaopinKucunNumber"
