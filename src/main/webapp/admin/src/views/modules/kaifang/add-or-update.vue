    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="huanzheId" name="huanzheId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="开方编号" prop="kaifangUuidNumber">
                       <el-input v-model="ruleForm.kaifangUuidNumber"
                                 placeholder="开方编号" clearable  :readonly="ro.kaifangUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="开方编号" prop="kaifangUuidNumber">
                           <el-input v-model="ruleForm.kaifangUuidNumber"
                                     placeholder="开方编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="药方名称" prop="kaifangName">
                       <el-input v-model="ruleForm.kaifangName"
                                 placeholder="药方名称" clearable  :readonly="ro.kaifangName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="药方名称" prop="kaifangName">
                           <el-input v-model="ruleForm.kaifangName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="开方类型" prop="kaifangTypes">
                        <el-select v-model="ruleForm.kaifangTypes" :disabled="ro.kaifangTypes" placeholder="请选择开方类型">
                            <el-option
                                v-for="(item,index) in kaifangTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="开方类型" prop="kaifangValue">
                        <el-input v-model="ruleForm.kaifangValue"
                            placeholder="开方类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="开方内容" prop="kaifangContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.kaifangContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.kaifangContent" label="开方内容" prop="kaifangContent">
                            <span v-html="ruleForm.kaifangContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    huanzheId: false,
                    kaifangUuidNumber: false,
                    kaifangName: false,
                    kaifangTypes: false,
                    kaifangContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    huanzheId: '',
                    kaifangUuidNumber: new Date().getTime(),
                    kaifangName: '',
                    kaifangTypes: '',
                    kaifangContent: '',
                    insertTime: '',
                ...
                rules: {
                   ...
                   kaifangUuidNumber: [
                              { required: true, message: '开方编号不能为空', trigger: 'blur' },
                          ],
                   kaifangName: [
                              { required: true, message: '药方名称不能为空', trigger: 'blur' },
                          ],
                   kaifangTypes: [
                              { required: true, message: '开方类型不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   kaifangContent: [
                              { required: true, message: '开方内容不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=kaifang_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.kaifangTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`kaifang/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.kaifangCrossAddOrUpdateFlag = false;
                                        this.parent.search();
