        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="病床编号" prop="bingchuangUuidNumber">
                       <el-input v-model="ruleForm.bingchuangUuidNumber"
                                 placeholder="病床编号" clearable  :readonly="ro.bingchuangUuidNumber"></el-input>
                   </el-form-item>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="房间名" prop="fangjianName">
                       <el-input v-model="ruleForm.fangjianName"
                                 placeholder="房间名" clearable  :readonly="ro.fangjianName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="是否使用" prop="shifoushiyongTypes">
                        <el-select v-model="ruleForm.shifoushiyongTypes" :disabled="ro.shifoushiyongTypes" placeholder="请选择是否使用">
                            <el-option
                                v-for="(item,index) in shifoushiyongTypesOptions"
    ...
    export default {
        data() {
            return {
                ...
                userId:"",//当前登录人的id
                ro:{
                    bingchuangUuidNumber: false,
                    fangjianName: false,
                    fangjianAddress: false,
                    chuanghao: false,
                    shifoushiyongTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    bingchuangUuidNumber: new Date().getTime(),
                    fangjianName: '',
                    fangjianAddress: '',
                    chuanghao: '',
                    shifoushiyongTypes: '',
                ...
                shifoushiyongTypesOptions : [],
                rules: {
                   bingchuangUuidNumber: [
                              { required: true, message: '病床编号不能为空', trigger: 'blur' },
                          ],
                   fangjianName: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=shifoushiyong_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shifoushiyongTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`bingchuang/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.bingchuangCrossAddOrUpdateFlag = false;
                                        this.parent.search();
