    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="电子邮箱" prop="yishengEmail">
                       <el-input v-model="ruleForm.yishengEmail"
                                 placeholder="电子邮箱" clearable  :readonly="ro.yishengEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="擅长" prop="yishengShanchang">
                       <el-input v-model="ruleForm.yishengShanchang"
                                 placeholder="擅长" clearable  :readonly="ro.yishengShanchang"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="擅长" prop="yishengShanchang">
                           <el-input v-model="ruleForm.yishengShanchang"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="所获荣誉" prop="yishengRongyu">
                       <el-input v-model="ruleForm.yishengRongyu"
                                 placeholder="所获荣誉" clearable  :readonly="ro.yishengRongyu"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="所获荣誉" prop="yishengRongyu">
                           <el-input v-model="ruleForm.yishengRongyu"
