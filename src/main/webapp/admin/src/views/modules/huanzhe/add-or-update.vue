               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="现住址" prop="xianAddress">
                       <el-input v-model="ruleForm.xianAddress"
                                 placeholder="现住址" clearable  :readonly="ro.xianAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="户籍地址" prop="hujiAddress">
                       <el-input v-model="ruleForm.hujiAddress"
                                 placeholder="户籍地址" clearable  :readonly="ro.hujiAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   huanzhePhoto: [
                              { required: true, message: '患者照片不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
